...
namespace PsihologicalProject
{
    ...
    /// </summary>
    public sealed partial class LTTestPage : Page
    {
        ...
        {
            Question.Navigate(typeof(PsihologicalProject.Tests.LazyTest.LTQuestion1));
        }
        ...
        {
            this.Frame.Navigate(typeof(LTResultPage));
        }
